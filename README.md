...
```bash
skillp add <source>       # 从 git 仓库添加 skill
skillp install            # 恢复 symlinks（clone 项目后执行，无需网络）
skillp update <name>      # 更新 skill 到最新版本
skillp update --all       # 更新全部 skills
skillp remove <name>      # 移除已安装的 skill
```
