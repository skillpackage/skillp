...
```bash
# SSH 格式
bunx skillp add git@github.com:chong/chong-skills.git --skill iwiki-ultra

# HTTPS 格式
bunx skillp add https://github.com/chong/chong-skills.git --skill iwiki-ultra

# 预览链接（无 .git 后缀，从浏览器地址栏复制）
bunx skillp add https://github.com/chong/chong-skills --skill iwiki-ultra

# GitHub 仓库
bunx skillp add git@github.com:owner/repo.git --skill my-skill

# 非交互模式（AI Agent 使用）
bunx skillp add git@github.com:chong/chong-skills.git --skill iwiki-ultra -y
```
